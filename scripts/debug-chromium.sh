...
step "9. /proc/net/tcp listening (port 9222 = 240E hex)"
awk 'NR>1 && $4=="0A" && $2 ~ /:240E$/ {print "    IPv4 listening: "$2}' /proc/net/tcp
awk 'NR>1 && $4=="0A" && $2 ~ /:240E$/ {print "    IPv6 listening: "$2}' /proc/net/tcp6
echo "    (no match = nothing on 9222)"
